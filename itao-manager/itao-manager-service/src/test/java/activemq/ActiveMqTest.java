...
public class ActiveMqTest {
	...
	public void testQueueProducer() throws Exception{
		ConnectionFactory connectionFactory=new ActiveMQConnectionFactory("tcp://192.168.72.135:61616");
		...
		TextMessage textMessage = session.createTextMessage("hello world11");
		//发送消息
